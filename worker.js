...
var Worker = {
    ...
    getBestMaintenanceTime:function(filePath,callback)
    {
        ...
        // data is a 2D array that will contain the counts of events for every
        // day of the week for every hour of the day. We will return the lowest 
        // hour in a 3 day window from that 2D array. This is ofcource not the 
        // best way calculate the maintenance day for international statistic 
        // but it is a rough estimation.
